export const keyToExpectedValueMap = {
  ...
  brokerValuation: "Broker Valuation?",
  ecuEngineControlUnit:"ECU (Engine Control Unit)",
  engineCoolingWaterFlow: "Engine Cooling Water Flow (ECWF)",
  engineExhaustTemperature: "Engine Exhaust Temperature (EET)",
  engineOperatingHours: "Engine Operating Hours (EOH)",
  enginePowerHpKw: "Engine Power (HP/KW)",
  engineRoomVolume: "Engine Room Volume (ERV)",
  engineRpm: "Engine RPM (RPM)",
  engineType:"Engine Torque (ET)"
};

export const typeDef = {
  engineDetails: {
    marisailVesselId: { value: "", type: "number", mandatory: true },
  ...
  condition: {
    ...
    seller: { value: "", type: "radio", mandatory: true },
    offeredBy: { value: "", type: "radio", mandatory: false },
  ...
  performance: {
    ...
    grossPowerFullLoadHpMetric: { value: "", type: "radio", mandatory: false },
    ...
    powerToWeightRatio: { value: "", type: "radio", mandatory: false },
    engineEfficiency: { value: "", type: "radio", mandatory: true },
    engineSpeedRange: { value: "", type: "radio", mandatory: true },
  ...
  engineParts: {
    engineBearings: { value: "", type: "radio", mandatory: false },
    engineBed: { value: "", type: "radio", mandatory: false },
    engineBlock: { value: "", type: "radio", mandatory: false },
    engineBracket: { value: "", type: "radio", mandatory: false },
    engineBreather: { value: "", type: "radio", mandatory: false },
    engineCompartment: { value: "", type: "radio", mandatory: false },
    engineCompartmentVentilation: {
      value: "",
      type: "radio",
      mandatory: false,
    },
    engineCoolingSystem: { value: "", type: "radio", mandatory: false },
    engineCover: { value: "", type: "radio", mandatory: false },

    engineDrivenPump: { value: "", type: "radio", mandatory: false },
    engineExhaustSystem: { value: "", type: "radio", mandatory: false },
    engineGasketSet: { value: "", type: "radio", mandatory: false },
    engineGearshift: { value: "", type: "radio", mandatory: false },
    engineHatch: { value: "", type: "radio", mandatory: false },
    engineHourMeter: { value: "", type: "radio", mandatory: false },
    engineInstrumentPanel: { value: "", type: "radio", mandatory: false },
    engineMaintenance: { value: "", type: "radio", mandatory: false },
    engineMounts: { value: "", type: "radio", mandatory: false },
    enginePanel: { value: "", type: "radio", mandatory: false },
    engineRemoteControl: { value: "", type: "radio", mandatory: false },
    engineStartButton: { value: "", type: "radio", mandatory: false },
    engineStopButton: { value: "", type: "radio", mandatory: false },
    engineTachometer: { value: "", type: "radio", mandatory: false },
    engineTelegraph: { value: "", type: "radio", mandatory: false },
    engineTemperatureGauge: { value: "", type: "radio", mandatory: false },
    engineThrottle: { value: "", type: "radio", mandatory: false },
    engineTransmission: { value: "", type: "radio", mandatory: false },
    engineTrunk: { value: "", type: "radio", mandatory: false },
    engineVoltageMeter: { value: "", type: "radio", mandatory: false },
    engineWarningLight: { value: "", type: "radio", mandatory: false },
    engineControlLever: { value: "", type: "radio", mandatory: false },
    engineControlPartsAndAccessories: {
      value: "",
      type: "radio",
      mandatory: false,
    },
    engineControlRoom: { value: "", type: "radio", mandatory: false },
  },
  engineMeasurements: {
    engineCoolingWaterFlow: { value: "", type: "radio", mandatory: false },
    engineExhaustTemperature: { value: "", type: "radio", mandatory: false },
    engineOperatingHours: { value: "", type: "radio", mandatory: false },
    enginePowerHpKw: { value: "", type: "radio", mandatory: false },
    engineRoomVolume: { value: "", type: "radio", mandatory: false },
    engineRpm: { value: "", type: "radio", mandatory: false },
    engineTorque: { value: "", type: "radio", mandatory: false }
  },
  engineRoom:{
    engineRoom: { value: "", type: "radio", mandatory: false },
    engineRoomFan: { value: "", type: "radio", mandatory: false },
    engineRoomFanExtractor: { value: "", type: "radio", mandatory: false },
    engineRoomInsulation: { value: "", type: "radio", mandatory: false },
    engineRoomLight: { value: "", type: "radio", mandatory: false },
    engineRoomSoundproofing: { value: "", type: "radio", mandatory: false },
    engineRoomVentilation: { value: "", type: "radio", mandatory: false }
  },
  engineShaft:{
    engineShaftBearing: { value: "", type: "radio", mandatory: false },
    engineShaftCollar: { value: "", type: "radio", mandatory: false },
    engineShaftCoupling: { value: "", type: "radio", mandatory: false },
    engineShaftKey: { value: "", type: "radio", mandatory: false },
    engineShaftLog: { value: "", type: "radio", mandatory: false },
    engineShaftNut: { value: "", type: "radio", mandatory: false },
    engineShaftSeal: { value: "", type: "radio", mandatory: false },
    engineShaftSealant: { value: "", type: "radio", mandatory: false },
    engineShaftSize: { value: "", type: "radio", mandatory: false },
    engineShaftSpacer: { value: "", type: "radio", mandatory: false },
    engineShaftStrut: { value: "", type: "radio", mandatory: false },
