        ...
        <Form>
          <Row>
            {Object.keys(form).map((key) => (
                <Col key={key} md={6} className="mt-4">
                  <h6 style={{ marginLeft: 10, color: "#1F75FE" }}>{makeString(key.toString())}</h6>
                  <Col md={12} className="mt-4 mr-3" style={{ width: "480px" }}>
                    {Object.keys(form[key]).map((key2) => (
                        <Col key={key2} xs={3} md={12} className="mb-2 myAcc">
                          {/* <SelectComponent
                            label={makeString(key2.toString())}
                            value={form[key][key2]}
                            setValue={(val) => {
                              setForm({ ...form, key2: val });
      ...
      {/* <Container className="mb-5">
        <Form>
          <Row>
            ...
            <Col md={6} className="mt-4">
              <h6 style={{ marginLeft: 10, color: "#1F75FE" }}>Basics</h6>
              <Col md={12} className="mt-4 mr-3" style={{ width: "480px" }}>
                <Col xs={3} md={12} className="mb-2 myAcc">
                  <SelectComponent
                    label="Type"
