...
import { varToColumn, varToTable, uniqueTable } from "../config/auctionSearchConfig.js";
...
searchAuctionRouter.post("/Auction", async (req, res) => {
  ...
  searchAuctionRouter.post("/auctionData", async (req, res) => {
    ...
    try {
        ...
        var required = "Lot_Number, Auction_Status, Results_or_Outcome, Auction_Number, Auction_Date";
